...
public abstract class ProcessingSequenceTemplateEditor implements ActionListener {
    ...
    public void register() {
        ...
        if (segmenterPanel != null) {
            segmenterPanel.register(ml);
        }
    ...
    protected void save(boolean record) {
        try {
            if (data == null) {
                data = new BasicDBObject("name", (String) processingSequences.getSelectedItem());
            }
