...
public class RoiInterpolator {

    public static Roi[] run(Roi[] rois) {
        int xmax = 0;
        ...
        for (Roi roi : rois) {
            ...
            final int slice = roi.getPosition();
        ...
        for (int s = 0; s < nSlices; s++) {
            ...
            int threshold = 255;
            if (ImageUtils.containsValue(bp, threshold)) {
